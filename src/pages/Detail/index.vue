<template>
  <div class="detail">
    ...
    <section class="con">
      ...
      <!-- <div class="conPoin" v-if="detailIfo.categoryView">
        <span>{{ detailIfo.categoryView.category1Name }}</span>
        <span>{{ detailIfo.categoryView.category2Name }}</span>
        <span>{{ detailIfo.categoryView.category3Name }}</span>
      </div> -->
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
